        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-100 dark:text-gray-800">
            <div className="flex flex-col justify-between">
                <div className="space-y-2">
                    ...
                    <div className="dark:text-gray-600">If you want to know about us kindly let us know.</div>
                </div>
                <img src="https://i.pinimg.com/564x/24/ff/cf/24ffcfb1e082b236f6898007351d7f76.jpg" alt="" className="p-6 h-52 md:h-96" />
            </div>
            <form onSubmit={handleSendMessage} noValidate="" className="space-y-6">
                <div>
